...
def sample_df() -> pd.DataFrame:
    ...
    return pd.DataFrame(
        {
            "occurrenceID": ["T2T1DJ", "T6WPKD", "TCSZX1", "TG4NHB", "TVCC3Y", "T4P82F"],
            "n_otu": [2307, 1597, 1058, 2294, 3854, 1700],
            "decimalLatitude": [62.976878, 62.981296, 62.976671, 62.976843, 62.976773, 62.978500],
            "decimalLongitude": [18.026823, 18.030991, 18.021154, 18.030649, 18.016718, 18.025000],
            "eventDate": [
                "2025-06-18",
                "2020-12-12",
                "1960-04-02",
